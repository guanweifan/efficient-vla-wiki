# 2606_19565_Mix-QVLA-headline-split

## 用途
- 当前页服务于 [[wiki/papers/2606_19565_Mix-QVLA.md|2606_19565_Mix-QVLA]] 的单篇证据落点，用来拆分新增论文的 headline、主效率瓶颈、secondary relevance 与后续待核 metric。
- 本页是 L1 scan-layer evidence；只承接 title / abstract / method-level 信息，不承担跨论文 synthesis。

## Evidence
- 方法证据命题：Use task-evidence- and time-aware sensitivity scores to allocate mixed precision across VLA layers, preserving internal decision evidence while reducing memory and BitOps. 来源：[[raw/2606_19565_Mix-QVLA.pdf]]，Title、Abstract、method section。
