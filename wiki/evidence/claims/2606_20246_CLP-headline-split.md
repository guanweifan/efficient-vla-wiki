# 2606_20246_CLP-headline-split

## 用途
- 当前页服务于 [[wiki/papers/2606_20246_CLP.md|2606_20246_CLP]] 的单篇证据落点，用来拆分新增论文的 headline、主效率瓶颈、secondary relevance 与后续待核 metric。
- 本页是 L1 scan-layer evidence；只承接 title / abstract / method-level 信息，不承担跨论文 synthesis。

## Evidence
- 方法证据命题：Use a single-pass CKA analysis to identify representationally redundant transformer layers and permanently prune VLA depth before downstream fine-tuning. 来源：[[raw/2606_20246_CLP.pdf]]，Title、Abstract、method section。
