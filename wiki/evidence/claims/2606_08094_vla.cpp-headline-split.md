# 2606_08094_vla.cpp-headline-split

## 用途
- 当前页服务于 [[wiki/papers/2606_08094_vla.cpp.md|2606_08094_vla.cpp]] 的单篇证据落点，用来拆分新增论文的 headline、主效率瓶颈、secondary relevance 与后续待核 metric。
- 本页是 L1 scan-layer evidence；只承接 title / abstract / method-level 信息，不承担跨论文 synthesis。

## Evidence
- 方法证据命题：Build a portable llama.cpp / ggml-based C++ runtime that natively serves flow-matching and diffusion VLA inference patterns across multiple VLA architectures and edge hardware tiers. 来源：[[raw/2606_08094_vla.cpp.pdf]]，Title、Abstract、method section。
