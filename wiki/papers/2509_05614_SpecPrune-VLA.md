...
- 需要显式保留的 caveat 是：这些 speedup 数字强烈依赖 benchmark、hardware 与 baseline。论文在 OpenVLA-OFT、`π0`、A800、RTX 3090 与 real-world Flexiv 实验上都给出过不同 end-to-end 改进，因此当前更适合把它理解成一组 family of efficiency claims，而不是单一统一倍数。
