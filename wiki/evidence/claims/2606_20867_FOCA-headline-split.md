# 2606_20867_FOCA-headline-split

## 用途
- 当前页服务于 [[wiki/papers/2606_20867_FOCA.md|2606_20867_FOCA]] 的单篇证据落点，用来拆分新增论文的 headline、主效率瓶颈、secondary relevance 与后续待核 metric。
- 本页是 L1 scan-layer evidence；只承接 title / abstract / method-level 信息，不承担跨论文 synthesis。

## Evidence
- 方法证据命题：Improve few-shot VLA adaptation by predicting task-grounded future interaction embeddings and aligning them with future goal observations in latent space, enabling data-efficient and action-free co-training. 来源：[[raw/2606_20867_FOCA.pdf]]，Title、Abstract、method section。
