# 2606_25800_ROAD-VLA-headline-split

## 用途
- 当前页服务于 [[wiki/papers/2606_25800_ROAD-VLA.md|2606_25800_ROAD-VLA]] 的单篇证据落点，用来拆分新增论文的 headline、主效率瓶颈、secondary relevance 与后续待核 metric。
- 本页是 L1 scan-layer evidence；只承接 title / abstract / method-level 信息，不承担跨论文 synthesis。

## Evidence
- 方法证据命题：Convert sparse online rewards into dense action-token supervision by constructing an advantage-guided proximal teacher directly in the VLA action-token space. 来源：[[raw/2606_25800_ROAD-VLA.pdf]]，Title、Abstract、method section。
