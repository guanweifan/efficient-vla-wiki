# 2606_12105_DAM-VLA-headline-split

## 用途
- 当前页服务于 [[wiki/papers/2606_12105_DAM-VLA.md|2606_12105_DAM-VLA]] 的单篇证据落点，用来拆分新增论文的 headline、主效率瓶颈、secondary relevance 与后续待核 metric。
- 本页是 L1 scan-layer evidence；只承接 title / abstract / method-level 信息，不承担跨论文 synthesis。

## Evidence
- 方法证据命题：Maintain per-modality latent buffers refreshed at each sensor's native rate and let a high-frequency action head continuously read them, avoiding synchronous oversampling of slow modalities. 来源：[[raw/2606_12105_DAM-VLA.pdf]]，Title、Abstract、method section。
