# 2606_26006_FORCE-headline-split

## 用途
- 当前页服务于 [[wiki/papers/2606_26006_FORCE.md|2606_26006_FORCE]] 的单篇证据落点，用来拆分新增论文的 headline、主效率瓶颈、secondary relevance 与后续待核 metric。
- 本页是 L1 scan-layer evidence；只承接 title / abstract / method-level 信息，不承担跨论文 synthesis。

## Evidence
- 方法证据命题：Stabilize VLA reinforcement fine-tuning with value-calibrated warm-up and value-guided policy self-distillation, filtering updates toward high-value actions for sample-efficient online adaptation. 来源：[[raw/2606_26006_FORCE.pdf]]，Title、Abstract、method section。
